...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., task_configs=None):
        ...
        """
       Task Adapted Attention Mechanism
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 fused_window_process=False, task_configs=None, hidden_size=343, use_tsn_layer=False):
        super().__init__()
        self.dim = dim
        ...
        self.use_tsn_layer = use_tsn_layer
        
        
        if task_configs is None or (not self.use_tsn_layer):
            self.norm1 = norm_layer(dim)
        else:
            self.norm1 = TaskScaledNorm(dim, hidden_size)
        ...
        if task_configs is None or (not self.use_tsn_layer):
            ...
            self.norm2 = TaskScaledNorm(dim, hidden_size)
    ...
    def forward(self, x, task_embedding=None, task_id = None):
        ...
        if self.task_configs is None or (not self.use_tsn_layer):
            x = self.norm1(x)
        else:
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 fused_window_process=False, task_configs=None, conditioned_blocks=[0], adapter=False, hidden_size=343, use_tsn_layer =False):
...
class BasicLayer_up(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 mlp_ratio=4., qkv_bias=True, qk_scale=None, drop=0., attn_drop=0.,
                 drop_path=0., norm_layer=nn.LayerNorm, upsample=None, use_checkpoint=False, use_tsn_layer=False):
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 conditioned_blocks = [[],[],[12],[]], adapter = False, use_tsn_layer = False,
                 **kwargs):
        super().__init__()
        ...
        ''' Decoder Module - one decoder head for each task'''
